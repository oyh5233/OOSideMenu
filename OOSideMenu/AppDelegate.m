...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    menu.backgroundImageView.image=[UIColor imageWithTopColor:[UIColor purpleColor] bottomColor:[UIColor orangeColor] size:CGSizeMake(CGRectGetWidth(self.window.frame), CGRectGetHeight(self.window.frame))];
